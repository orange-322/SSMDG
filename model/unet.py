...
class Decoder(nn.Module):
    ...
    def __init__(self, params):
        ...
        self.up1 = UpBlock(self.ft_chns[4],
                           self.ft_chns[3],
                           self.ft_chns[3],
                           dropout_p=0.0)
        self.up2 = UpBlock(self.ft_chns[3],
                           self.ft_chns[2],
                           self.ft_chns[2],
                           dropout_p=0.0)
        self.up3 = UpBlock(self.ft_chns[2],
                           self.ft_chns[1],
                           self.ft_chns[1],
                           dropout_p=0.0)
        self.up4 = UpBlock(self.ft_chns[1],
                           self.ft_chns[0],
                           self.ft_chns[0],
                           dropout_p=0.0)
...
class UNet(nn.Module):
    ...
    def __init__(self,
        ...
        drop = [0.05, 0.1, 0.2, 0.3, 0.5]
        feat = [2**i * num_filters for i in range(5)]
        params = {
            'in_chns': in_chns,
            # 'feature_chns': [16, 32, 64, 128, 256],
            'feature_chns': feat,
            'dropout': drop if use_dropout else [0.0] * len(drop),
            'class_num': class_num,
            'bilinear': False,
        }
